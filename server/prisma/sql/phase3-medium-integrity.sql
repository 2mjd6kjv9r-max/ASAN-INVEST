-- Phase 3 medium-severity integrity. Applied by 20260922160000_phase3_medium_integrity.
-- Empty-string unique keys and unbounded payment payloads.
...
ALTER TABLE users DROP CONSTRAINT IF EXISTS users_virtual_fin_nonempty;
ALTER TABLE users DROP CONSTRAINT IF EXISTS users_fin_nonempty;
...
ALTER TABLE payments DROP CONSTRAINT IF EXISTS payments_provider_ref_nonempty;
ALTER TABLE payments DROP CONSTRAINT IF EXISTS payments_raw_payload_size;
